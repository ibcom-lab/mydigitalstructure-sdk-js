...
mydigitalstructure._util.view.handlers['myds-enter'] = function(e)
{
    if (e.which == 13)
    {
    	var element = $(this);
        ...
        {
            mydigitalstructure._util.view.handlers['myds-click']({currentTarget: $(routeToSelector)});
        }
        else
        {
...
.on('keypress', '.myds-enter', mydigitalstructure._util.view.handlers['myds-enter']);
...
mydigitalstructure._util.view.handlers['myds-text'] = function (event)
{
	...
	if (enter == undefined)
    { 
        enter = mydigitalstructure._scope.app.options.textEnterDefault
    }
	...
	add: function(param)
	{
		if (_.isArray(param))
		{
			...
			_.each(param, function(controller)
			{
				if (controller.name != undefined)
				{
					...
					{
						mydigitalstructure._util.controller.code[controller.name + '_'] = _.clone(mydigitalstructure._util.controller.code[controller.name]);
						mydigitalstructure._util.log.add({message: 'Existing controller [' + controller.name + '] was just replaced - existing controller renamed to [' + controller.name + '_]'})
					}
		...
		else
		{
			...
			if (name != undefined)
			{
				...
				{
					mydigitalstructure._util.controller.code[name + '_'] = mydigitalstructure._util.controller.code[name];
					mydigitalstructure._util.log.add({message: 'Existing controller [' + name + '] was just replaced - existing controller renamed to [' + name + '_]'});
				}
...
mydigitalstructure._util.view.popover =
{
	init: function (param)
	{
		var selector = mydigitalstructure._util.param.get(param, 'selector', {default: '.popover:visible'}).value;
		var title = mydigitalstructure._util.param.get(param, 'title', {default: ''}).value;
		var isHTML = mydigitalstructure._util.param.get(param, 'isHTML', {default: true}).value;
		var placement = mydigitalstructure._util.param.get(param, 'placement', {default: 'auto'}).value;
		var sanitize = mydigitalstructure._util.param.get(param, 'sanitize', {default: false}).value;
		var options =  mydigitalstructure._util.param.get(param, 'options', {default: {}}).value;
		...
		var showCancel =  mydigitalstructure._util.param.get(param, 'showCancel', {default: true}).value;
		var buttonClass =  mydigitalstructure._util.param.get(param, 'buttonClass', {default: 'btn-primary myds-click myds-close'}).value;
		var buttonData =  mydigitalstructure._util.param.get(param, 'buttonData', {default: ''}).value;
		var buttonText =  mydigitalstructure._util.param.get(param, 'buttonText', {default: 'OK'}).value;
		var buttonController =  mydigitalstructure._util.param.get(param, 'buttonController').value;
...
[
	{
		...
		code: function (param)
		{
			mydigitalstructure._util.view.popover.init(param);
		}
	},
	{
		...
		code: function (param)
		{
			mydigitalstructure._util.view.popover.hide(param);
	...
	},
	{
		...
		code: function (param)
		{
			mydigitalstructure._util.view.popover.show(param);
...
mydigitalstructure._util.controller.add(
{
	...
	code: function (param)
	{
        ...
        if (_.isSet(modify))
        {
            ...
            {
                var _date = moment(date, mydigitalstructure._scope.app.options.dateFormats)
...
mydigitalstructure._util.view.show = function (param)
{
    var context = mydigitalstructure._util.param.get(param, 'context').value;
    var selector = mydigitalstructure._util.param.get(param, 'selector').value;
    var collapse = mydigitalstructure._util.param.get(param, 'collapse', {default: false}).value;
...
mydigitalstructure._util.view.hide =  function (param)
{
    var context = mydigitalstructure._util.param.get(param, 'context').value;
    var selector = mydigitalstructure._util.param.get(param, 'selector').value;
    var collapse = mydigitalstructure._util.param.get(param, 'collapse', {default: false}).value;
    var toast = mydigitalstructure._util.param.get(param, 'toast', {default: false}).value;
...
[
	{
		...
		code: function (param)
		{
			mydigitalstructure._util.view.show(param);
		}
	},
	{
		name: 'util-view-hide',
		code: function (param)
		{
			mydigitalstructure._util.view.hide(param);
		}
	},
	{
...
mydigitalstructure._util.whenCan =
{
    queue: 		[],
    completed: 	[],
    exists: 	function (param)
    {
        if (param && param.uuid)
        {
            return (_.filter(mydigitalstructure._util.whenCan.whenCan.queue, function (queue) {queue.uuid == param.uuid}).length > 0)
        }	
        else
        {	
            return (mydigitalstructure._util.whenCan.queue.length != 0);
        }	
    },
    ...
    invoke: function(param)
    {
        ...
        mydigitalstructure._util.whenCan.queue.unshift(param.then);
    ...
    complete: function(returnData, param)
    {
        ...
        {	
            ...
            if (param.uuid)
            {
                _.each(mydigitalstructure._util.whenCan.queue, function (queue, q)
                {
                    if (queue)
                    {	
                        ...
                        {
                            thenQueue = queue;
                            mydigitalstructure._util.whenCan.queue.splice(q, 1);
                        }
                    }	
                });
            }	
            ...
            {	
                thenQueue = mydigitalstructure._util.whenCan.queue.shift();
            }

            if (thenQueue)
            {	
                mydigitalstructure._util.whenCan.completed.unshift(thenQueue);
                ...
                {
                    mydigitalstructure._util.controller.invoke(executeController, param)	
                }
            }	
        }
...
mydigitalstructure._util.factory.core = function (param)
{
	...
	[
						...
						{	
							...
							else
							{
								if (_.isObject(mydigitalstructure._scope.user))
								{
                                    ...
                                    if (mydigitalstructure.space != undefined)
                                    {
									    $('.myds-logon-space').html(mydigitalstructure.space.whoAmI().name);
                                    
                                        if(mydigitalstructure.space.isSwitched())
                                        {
		...
		},
		{
			...
			code: function (param)
			{
				...
				if (context != undefined)
				{
					type = mydigitalstructure._util.data.get(
					{
		...
		},
		{
			...
			code: function (param)
			{
				return mydigitalstructure.cloud.search(param)
			}
		},
		{
	...
	mydigitalstructure._util.controller.add(
	{
		...
		code: function (param, response)
		{
			...
			var rows = mydigitalstructure._util.param.get(param, 'rows').value;
						...
						var ajax = 
						{
							...
							data: function (query)
							{
					    		...
					    		else
					    		{
							    	...
							    	if (_.has(mydigitalstructure, '_scope.app.options.rows'))
							    	{
							    		dataQueryRows = mydigitalstructure._scope.app.options.rows;
							    	}
	...
	mydigitalstructure._util.controller.add(
	{
		...
		code: function (param, response)
		{
			...
			var hide = mydigitalstructure._util.param.get(param, 'hide', {default: false}).value;
           	var refresh = mydigitalstructure._util.param.get(param, 'refresh', {default: false}).value;
			...
			if (userHasAccess)
			{
				...
				else
				{
					...
					if (response != undefined || param.sort != undefined || param.rowsPerPage != undefined)
					{
                        ...
                        refresh = mydigitalstructure._util.param.get(param, 'refresh', {default: false}).value;
					}
		...
		},
		{
			...
			code: function (param, response)
			{
				...
				if (filename != undefined)
				{
					...
					if (mydigitalstructure._scope.app.site != undefined)
					{
						url += '/' + mydigitalstructure._scope.app.site
					}
    ...
    mydigitalstructure._util.controller.add(
    {
        ...
        {            
            ...
            if (response == undefined)
            {
                ...
                {
                    message = mydigitalstructure._util.param.get(param, 'message').value;
                    data = mydigitalstructure._util.param.get(param, 'data').value;
    ...
    [
        {
            ...
            code: function (param)
            {
                return mydigitalstructure.space.isSwitched(param);
            }
        },
        {
            ...
            code: function (param)
            {
                return mydigitalstructure.space.whoAmI(param);
            }
        },
        {
            ...
            code: function (param)
            {
                var scope = mydigitalstructure._util.param.get(param, 'scope', {default: 'util-space-switch-into'}).value;
                var data = mydigitalstructure._util.data.get({scope: scope});
                param = _.assign(param, {id: data.id});

                mydigitalstructure.space.switchInto(param);
            }
        },
        {
            ...
            code: function (param)
            {
                mydigitalstructure.space.switchBack(param);
            }
        }
    ]);
    ...
    mydigitalstructure._util.controller.add(
    {
        ...
        code: function (param)
        {
            mydigitalstructure._util.view.hide({toast: true})
        }
    });
    ...
    mydigitalstructure._util.controller.add(
    {
        ...
        code: function (param, response)
        {
            var field = mydigitalstructure._util.param.get(param, 'field', {default: 'id'}).value;
            var data = mydigitalstructure._util.param.get(param, 'data', {default: []}).value;
            var defaultIDs = mydigitalstructure._util.param.get(param, 'default').value;
