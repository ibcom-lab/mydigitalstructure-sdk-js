									...
									$.ajax(
									{
										...
										success: function (data)
										{
											...
											{		
												...
												if (mydigitalstructure._scope.authenticationLevel == 3 || mydigitalstructure._scope.authenticationLevel == 4)
												{	
					...
					send: 	function (param)
								{
									...
									$.ajax(
									{
										...
										{		
											if (data.status == 'ER')
											{
                                                if (mydigitalstructure._scope.authenticationLevel == 4 &&
	...
	logoff: 	function (param)
				{
                    ...
                    if (uri == undefined && _.has(mydigitalstructure, '._scope.app.options.deauthURI'))
					{
					    uri = mydigitalstructure._scope.app.options.deauthURI; //eg /deauth
					}
					...
					queue:
							{
								...
								templateRender: function (selector, param, data, template)
								{
									...
									if (mydigitalstructure._util.view.queue._util.userHasAccess(param))
									{
										...
										mydigitalstructure._util.view.queue.add(template, {queue: param.queue, type: 'template', selector: selector});
